...
//7 main function
    ...
    //7.2 Configure fitting parametres
        ...
        //Shoulder
                    ...
                    // ComPos->SetParameter(NUM_PAR_SIG+1, 5020);
                    // ComPos->SetParLimits(NUM_PAR_SIG+1,5020,5020);
    ...
    //7.5 Error Calculating
            ...
            /*
                ...
                Double_t ErrSigPos = ErrAPlusB(errPos[1]/BIN_WID, errPos[3]/BIN_WID, 0);
                Double_t ErrSigNeg = ErrAPlusB(errNeg[1]/BIN_WID, errNeg[3]/BIN_WID, 0);
                Double_t ErrNPos = ErrAMultB(NPos, parPos[5]/BIN_WID, (parPos[3]+parPos[1])/BIN_WID, errPos[5]/BIN_WID, ErrSigPos, 0);
